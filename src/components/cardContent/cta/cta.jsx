...
//     <section
//       ref={ref}
//       className={`relative py-spacing-8 text-center overflow-hidden ${componentBgColor} ${borderColor} ${borderRadius} text-shadow`}
//       style={
//         backgroundImage
//           ? {
...
//         <motion.h2
//           className={`${titleColor} ${titleSize} ${titleFontWeight} ${fontType} ${shadow}`}
